...
### IF IT IS NOT UPLOADING TO GITHUB JUST REDUCE THE NUMBER OF new_data AND max_features at Main.ipynb


# To run the app.py file and access the UI :  streamlit run app.py 
